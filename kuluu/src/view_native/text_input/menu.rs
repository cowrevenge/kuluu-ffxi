...
fn toggle_debug_panel(
    ...
    use kuluu_render::hud::menu::{
        DEBUG_AUTO_ENTER_CS, DEBUG_BODY_SMOOTHER, DEBUG_CAMERA_SMOOTHER, DEBUG_ENTITY_LIST,
        DEBUG_FOG, DEBUG_GRAPHICS_DEBUG, DEBUG_MESH, DEBUG_NAMEPLATES, DEBUG_NET_STATUS,
    ...
    let on = match label {
        ...
        DEBUG_CAMERA_SMOOTHER => {
            hud_panels.camera_smoother_off = !hud_panels.camera_smoother_off;
            !hud_panels.camera_smoother_off
        }
        DEBUG_BODY_SMOOTHER => {

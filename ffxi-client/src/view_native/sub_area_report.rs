...
//! [`ffxi_viewer_core::sub_area_activation`] makes goes out as c2s `0x0F2`
...
use bevy::prelude::*;
use ffxi_viewer_core::sub_area_activation::SubAreaChanged;
...
mod tests {
    ...
    fn no_sub_area_sentinel_matches_the_wire() {
        assert_eq!(
            ffxi_viewer_core::sub_area_activation::NO_SUB_AREA,

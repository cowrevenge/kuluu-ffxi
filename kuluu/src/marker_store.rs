...
use bevy::prelude::*;
use kuluu_render::hud::map_screen::{MapMarker, MapMarkers};
use kuluu_render::snapshot::{system_chat_line, SceneState};
...
impl MarkerStore {
    ...
    pub fn default_path() -> Result<PathBuf> {
        kuluu_session::config_dir::config_file("markers.json")
    }

...
mod tests {
    ...
    fn door_entity(id: u32, animation: u8) -> ffxi_viewer_wire::Entity {
        ffxi_viewer_wire::Entity {
            id,
            act_index: 7,
            kind: ffxi_viewer_wire::EntityKind::Other,
            name: None,
            pos: ffxi_viewer_wire::Vec3::default(),
            heading: 0,
            hp_pct: None,
            bt_target_id: 0,
            face_target: 0,
            ...
            mount: None,
            status: 0,
            char_flags: ffxi_viewer_wire::CharFlags::default(),
        }
    }

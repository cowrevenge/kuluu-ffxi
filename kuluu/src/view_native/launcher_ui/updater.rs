...
mod tests {
    ...
    const SUMS: &str = "\
0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef  kuluu-v0.2.0-x86_64-linux.tar.gz
fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210 *kuluu-v0.2.0-aarch64-macos.tar.gz
";

    #[test]
    fn parse_sha256sums_matches_filename() {
        assert_eq!(
            parse_sha256sums(SUMS, "kuluu-v0.2.0-x86_64-linux.tar.gz").as_deref(),
    ...
    fn parse_sha256sums_strips_binary_star() {
        assert_eq!(
            parse_sha256sums(SUMS, "kuluu-v0.2.0-aarch64-macos.tar.gz").as_deref(),

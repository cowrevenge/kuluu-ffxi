...
fn profile_header(
    ...
    me: Option<&kuluu_snapshot::PartyMember>,
) -> String {
    let name = me
...
fn attr_value(stats: &kuluu_snapshot::CharStats, attr_index: usize) -> Option<u16> {
...
pub fn play_time_chat_line(snap: &kuluu_snapshot::SceneSnapshot) -> String {
